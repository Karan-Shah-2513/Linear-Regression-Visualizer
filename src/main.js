...
function _rSquaredPlot(RSquaredPlot, width) {
  return RSquaredPlot({ width: width });
}
...
function _RSquaredPlot(d3) {
  return function RSquaredPlot({
    data,
...
function _RegressionPlot(d3) {
  return function RegressionPlot(
    data,
    {
